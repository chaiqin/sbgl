<?php /* Smarty version Smarty-3.1.6, created on 2017-09-23 15:21:08
         compiled from "Admin/View\Borrow\borrowList.html" */ ?>
<?php /*%%SmartyHeaderCode:3233159c60b644afa83-16848518%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b99759a26c0f0556036d684acf27eca58308158' => 
    array (
      0 => 'Admin/View\\Borrow\\borrowList.html',
      1 => 1496643657,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3233159c60b644afa83-16848518',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_59c60b647394d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c60b647394d')) {function content_59c60b647394d($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        <title>
...
/Admin/css/extra.css" media="all">
    ...
    <body>
        ...
        <div class="x-body">
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="add('添加出借', '<?php echo @__CONTROLLER__;?>
/addBorrow', '700', '500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：<span id="total"></span> 条</span></xblock>
...
/borrowList",
                        ...
                        for (var i = 0; i < list.length; i++) {
                            ...
                            str += "<td class='td-manage'>" +
                                    ...
                                    "	</a>" +
                                    "	<a title='验收' href='javascript:;' onclick=" + '"' + "check('验收','<?php echo @__CONTROLLER__;?>
/checkBorrow/id/" + list[i]['br_id'] + "','4','700','500')" + '"' +
                                    "	class='ml-5' style='text-decoration:none'>" +
                                    "		<i class='layui-icon'>&#xe63c;</i>" +
                                    "	</a>" +
                                    "	<a title='编辑' href='javascript:;' onclick=" + '"' + "edit('编辑','<?php echo @__CONTROLLER__;?>
/reviseBorrow/id/" + list[i]['br_id'] + "','4','700','500')" + '"' +
                                    "	class='ml-5' style='text-decoration:none'>" +
                                    "		<i class='layui-icon'>&#xe642;</i>" +
                                    "	</a>" +
...
/deleteBorrow", {id: s}, function (data) {
                            if (data.msg) {
...
/changeStatus", {id: id, status: 3}, function (data) {
                ...
                function del(obj, id) {
                    layer.confirm("确定删除吗？", function (index) {
                        //发异步删除数据
                        $.post("<?php echo @__CONTROLLER__;?>
/deleteBorrow", {id: id}, function (data) {
                            if (data.msg) {
                                layer.msg(data.msg, {icon: 1, time: 1000});
                                if (data.status) {
                                    $('input[name="uid"]:checked').each(function () {
